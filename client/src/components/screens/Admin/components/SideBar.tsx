            ...
            <div className="border-r border-y flex-1 pb-5">
                <div className="mt-6">
                    ...
                    <Link href='/admin/orders'>
                        <a className={`pl-6 py-2 mt-3 flex gap-3 transition-colors child:child:transition-colors child:child:hover:stroke-white hover:text-white hover:bg-maingreen ${pathName.includes('/admin/orders') ? 'bg-maingreen text-white' : ''}`}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.25 8.25H21.75M2.25 9H21.75M5.25 14.25H11.25M5.25 16.5H8.25M4.5 19.5H19.5C20.0967 19.5 20.669 19.2629 21.091 18.841C21.5129 18.419 21.75 17.8467 21.75 17.25V6.75C21.75 6.15326 21.5129 5.58097 21.091 5.15901C20.669 4.73705 20.0967 4.5 19.5 4.5H4.5C3.90326 4.5 3.33097 4.73705 2.90901 5.15901C2.48705 5.58097 2.25 6.15326 2.25 6.75V17.25C2.25 17.8467 2.48705 18.419 2.90901 18.841C3.33097 19.2629 3.90326 19.5 4.5 19.5Z" stroke={pathName.includes('/admin/orders') ? 'white' : 'black'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
