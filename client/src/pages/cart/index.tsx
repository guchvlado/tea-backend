      ...
      <div className="w-full lg:w-[820px] mx-auto py-24">
        <div className="flex justify-between items-center">
          ...
          <div onClick={onClearCart} className="flex items-center ml-8 text-xs md:ml-0 md:text-lg cursor-pointer child:text-gray-300 child:duration-300 child:hover:text-gray-900 group">
            <svg
              ...
              viewBox="0 0 20 20"
              fill="none"
              className='group-hover:child:stroke-gray-900 child:duration-300'
              xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div className="my-12">
          ...
          <div className="flex justify-between mt-12">
            <Link href="/">
              <a className='flex justify-center items-center gap-4 min-w-[200px] border rounded-full child:text-gray-400 hover:bg-black child:hover:text-white duration-300 child:duration-300'>
                <svg
                  width="8"
                  height="14"
                  viewBox="0 0 8 14"
